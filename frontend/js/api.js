...
const API_CONFIG = {
    ...
    endpoints: {
        ...
        listEvents: '/api/events/' // Endpoint lấy danh sách sự kiện
    },
...
// Lấy danh sách sự kiện (có thể truyền query string)
async function fetchEvents(params = {}) {
    ...
    const endpoint = API_CONFIG.endpoints.listEvents + (qs ? `?${qs}` : '');
